...
const routes: Routes = [
    ...
    // { path: 'help-guides', data: { breadcrumb: 'Help-guides' }, loadChildren: () => import('../components/help-guide/help-guide.module').then(m => m.HelpGuideModule) },
...
export class MindSparkRoutingModule {
