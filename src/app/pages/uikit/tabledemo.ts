            ...
            >
                <ng-template #caption>
                    <div class="flex justify-between items-center flex-column sm:flex-row">
                        <button pButton label="Clear" class="button pButton -outlined mb-2" icon="pi pi-filter-slash" (click)="clear(dt1)"></button>
            ...
            <p-table [value]="products" dataKey="id" [tableStyle]="{ 'min-width': '60rem' }" [expandedRowKeys]="expandedRows">
                <ng-template #caption>
                    <button pButton (click)="expandAll()">
                        <i [class]="isExpanded ? 'pi pi-fw pi-minus' : 'pi pi-fw pi-plus'"></i>
                ...
                <ng-template #body let-product let-expanded="expanded">
                    <tr>
                        <td>
                            <p-button [pRowToggler]="product" [text]="true" [rounded]="true" [plain]="true" [icon]="expanded ? 'pi pi-chevron-down' : 'pi pi-chevron-right'" />
                        </td>
                        <td>{{ product.name }}</td>
                        <td>
