...
const routes: Routes = [
    ...
    // { path: 'servicerequest', data: { breadcrumb: 'ServiceRequest' }, loadChildren: () => import('../components/service-request/service-request.module').then(m => m.ServiceRequestModule) },
...
export class BigLeadsRoutingModule {
