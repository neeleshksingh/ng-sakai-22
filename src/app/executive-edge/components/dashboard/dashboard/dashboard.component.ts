...
import { ActiveFeedbackAnnouncementComponent } from '../active-feedback-announcement/active-feedback-announcement.component';
import { FeedBackChartComponent } from '../feed-back-chart/feed-back-chart.component';
...
@Component({
    ...
    imports: [SharedModule, FeedBackChartComponent]
})
