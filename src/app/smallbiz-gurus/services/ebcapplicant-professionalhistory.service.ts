...
export class EBCApplicantProfessionalHistoryService extends GenericServiceNols<EBCApplicantProfessionalHistory, EBCApplicantProfessionalHistory> {
    ...
    getEBCApplicantProfessionalHistoryByJobApplicationId(JobApplicationId: number) {
        return this.http.get<EBCApplicantProfessionalHistory>(environment.apiHumanResourcesUrl + '/EBCApplicantProfessionalHistory/GetByJobApplicationId/' + JobApplicationId);
    }
}